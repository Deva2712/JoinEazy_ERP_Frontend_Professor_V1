...
import { RotateCcw, Trash2, CheckCircle2, TrendingUp, ChevronDown } from "lucide-react";
import RevalStatusBadge from "./RevalStatusBadge";
            ...
            {requests.map((req) => {
                ...
                return (
                    <div
                        ...
                        className={`bg-white dark:bg-[#1a1d26] rounded-2xl border transition-all duration-300 ${
                            isExpanded
                                ? "border-violet-300 dark:border-violet-800 shadow-lg"
                                : "border-gray-200 dark:border-gray-800 cursor-pointer hover:border-violet-300 dark:hover:border-violet-800 hover:shadow-md hover:-translate-y-0.5"
                        }`}
                    >
                        <div className="p-4">
                            ...
                            {/* Quick summary chip — only when collapsed */}
                            {!isExpanded && (
                                <div className="flex items-center justify-between mt-3">
                                    <p className="text-xs font-semibold text-gray-500 dark:text-gray-400">
                                        {req.originalMarks}/{req.maxMarks}
                                        {req.revisedMarks !== null && req.revisedMarks !== undefined && (
                                            <span className="text-green-600 dark:text-green-400"> → {req.revisedMarks}/{req.maxMarks}</span>
                                        )}
                                    </p>
