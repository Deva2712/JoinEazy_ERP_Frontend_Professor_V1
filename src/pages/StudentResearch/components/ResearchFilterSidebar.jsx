// src/pages/StudentResearch/components/ResearchFilterSidebar.jsx
							...
							<div className="grid grid-cols-1 gap-1">
								{[
									...
									<button
										...
										className={`flex items-center justify-between px-3 py-2 rounded-xl text-sm transition-all ${filters.sortBy === sort.id ? "text-blue-700 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 font-bold" : "text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50"}`}
									>
										{sort.label}
								...
								{[
									...
									>
										<div className="flex items-center gap-3">
											<div
												className={`size-5 rounded-md border transition-all flex items-center justify-center ${filters[type.id] ? "bg-blue-500 border-blue-500" : "border-gray-300 dark:border-gray-700"}`}
											>
												<input
													type="checkbox"
													className="hidden"
							...
							>
								<div className="relative mb-2 group px-1">
									...
									<input
										...
										className="w-full pl-9 pr-4 py-2.5 bg-gray-50 dark:bg-gray-800/50 border border-transparent focus:border-blue-500/30 dark:focus:border-blue-500/50 focus:ring-4 focus:ring-blue-500/5 rounded-xl text-sm text-gray-900 dark:text-gray-100 outline-none transition-all placeholder:text-gray-400 dark:placeholder:text-gray-600"
									/>
								</div>
								<div className="grid grid-cols-1 gap-1 max-h-48 overflow-y-auto no-scrollbar">
									{categorySearch === "" && (
										<button
											...
											className={`flex items-center justify-between px-3 py-2 rounded-xl text-sm transition-all ${filters.category === "all" ? "bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 font-bold" : "text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50"}`}
										>
											All Categories
											{filters.category === "all" && (
												<Check className="size-4" />
									...
									{filteredCategories.map((cat) => (
										<button
											...
											className={`flex items-center justify-between px-3 py-2 rounded-xl text-sm transition-all ${filters.category === cat ? "bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 font-bold" : "text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50"}`}
										>
								...
								<div className="grid grid-cols-1 gap-1">
									{[
										...
										<button
											...
											className={`flex items-center justify-between px-3 py-2 rounded-xl text-sm transition-all ${filters.status === status.id ? "text-blue-700 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 font-bold" : "text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50"}`}
										>
											{status.label}
								...
								<div className="grid grid-cols-1 gap-1">
									{[
										...
										<button
											...
											className={`flex items-center justify-between px-3 py-2 rounded-xl text-sm transition-all ${filters.collaborationType === mode ? "text-blue-700 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 font-bold" : "text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50"}`}
										>
