...
export default function MyCoursesUI({
	...
	const normaliseCohort = (c) => ({
		...
		member_count: c.member_count ?? c.memberCount ?? c.studentCount ?? c.students ?? 0,
		assignment_count: c.assignment_count ?? c.assignmentCount ?? c.total_assignments ?? c.totalAssignments ?? 0,
		due_this_week_assignment_count: c.due_this_week_assignment_count ?? 0,
		completed_assignment_count: c.completed_assignment_count ?? 0,
