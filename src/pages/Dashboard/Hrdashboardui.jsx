// src/pages/Dashboard/HrDashboardUI.jsx
...
import hrNavCards from "./config/Hrnavcards";
...
export default function HrDashboardUI({
  loading = false,
  error = null,
  onRetry = () => {},
  userProfile = {
    fullName: "Ms. HR Manager",
    employeeId: "HR-001",
  ...
  const filteredNavCards = hrNavCards.filter(
    ({ label, sublabel }) =>
  ...
  return (
    <div className="bg-gray-50 dark:bg-[#0f1117] min-h-screen font-sans">
      ...
      {/* Hero — violet/purple theme to differentiate from HOD (teal) and Professor (blue) */}
      <div className="bg-gradient-to-r from-violet-700 via-purple-800 to-fuchsia-800 dark:from-violet-900 dark:via-purple-950 dark:to-fuchsia-950 text-white">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="grid lg:grid-cols-2 gap-8 items-center">

            <div className="space-y-1">
              <span className="inline-flex items-center gap-1.5 text-[10px] font-black uppercase tracking-widest px-3 py-1 bg-white/15 rounded-full text-violet-100 mb-2">
                <Briefcase className="size-3" /> Human Resources
              </span>
              <h1 className="text-3xl font-bold">👋 Welcome back, {greetingName}!</h1>
              <p className="text-violet-100 text-lg">
                Manage employee records, leave approvals, payroll, and HR operations.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-4 lg:justify-end w-full text-white">
              <div className="bg-white/10 dark:bg-white/5 p-5 rounded-2xl border border-white/10 backdrop-blur-md flex-1 min-w-[220px] shadow-sm">
                <div className="flex items-center gap-3 mb-2 text-violet-200">
