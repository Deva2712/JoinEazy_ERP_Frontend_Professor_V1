...
// 			const [dashResponse, scheduleResponse, leaveResponse] = await Promise.all([
...
// 			// ✅ HoD/HR ke liye localStorage role check karo — API se milne wala
// 			// isAllowedCreate false aa sakta hai, so role bhi dekho
// 			const role = localStorage.getItem("userRole");
// 			const isStaff = data.isAllowedCreate || role === "professor" || role === "hod" || role === "hr";
...
// 				// ✅ department field add kiya — HodDashboardUI mein use hota hai
